...
public class MD5ForkJoinTest {
    ...
    public void oneFileTest() throws Exception {
        assertEquals(file1Hash, MD5ForkJoin.getMD5(file1));
        assertEquals(file2Hash, MD5ForkJoin.getMD5(file2));
    }

    @Test
    public void directoryWithOneFile() throws Exception {
        assertEquals("DIR" + file1Hash, MD5ForkJoin.getMD5(new File("./src/test/resources/DIR")));
    }

    @Test
    public void emptyDirectory() throws Exception {
        assertEquals("DIRR", MD5ForkJoin.getMD5(new File("./src/test/resources/DIRR")));
    }

    @Test
    public void recursiveDirectory() throws Exception {
        assertEquals("resourcesDIR" + file1Hash + "DIRR" + file2Hash, MD5ForkJoin.getMD5(new File("./src/test/resources")));
    }
